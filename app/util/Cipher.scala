...
object Cipher {
  ...
  private def doFinal(value: Array[Byte],
                      mode: Int,
                      algorithm: String,
                      secretKey: String,
                      initVector: String,
                      blockMode: String,
                      padding: String): Try[Array[Byte]] = Try {
  ...
  def encrypt(value: Array[Byte],
              algorithm: String,
              secretKey: String,
              initVector: String,
              blockMode: String,
              padding: String): Try[Array[Byte]] = {
    doFinal(value, JCipher.ENCRYPT_MODE, algorithm, secretKey, initVector, blockMode, padding)
  }

  def decrypt(value: Array[Byte],
              algorithm: String,
              secretKey: String,
              initVector: String,
              blockMode: String,
